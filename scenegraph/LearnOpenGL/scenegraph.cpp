// From https://learnopengl.com/Guest-Articles/2021/Scene/Scene-Graph
//
// sudo apt install libglfw3-dev libstb-dev
// g++ -o scenegraph ./glad/src/glad.c scenegraph.cpp -I ./ -I ./glad/include -lglfw -lstb -lassimp
...
int main()
{
	...
	// load entities
	// -----------
	Model model("FinalBaseMesh.obj");// = Model(FileSystem::getPath("resources/objects/planet/planet.obj"));
