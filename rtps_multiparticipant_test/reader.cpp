...
//=====================================================================================================================
Reader::Reader(const ReaderCallback& fn) : Endpoint(0, "READER_NODE"), listener_(fn), reader_(nullptr)
//=====================================================================================================================
{
    ...
    reader_qos_.m_liveliness.announcement_period.seconds = Endpoint::DISCOVERY_ANNOUNCE_PERIOD.count();
    ...
    reader_ = eprosima::fastrtps::rtps::RTPSDomain::createRTPSReader(participant_, reader_attr_, history_.get(), &listener_);
    if (reader_ == nullptr)
    {
