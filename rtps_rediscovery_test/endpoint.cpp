...
//=====================================================================================================================
{
    ...
    participant_params_.builtin.leaseDuration_announcementperiod.seconds = PARTICIPANT_DISCOVERY_ANNOUNCE_PERIOD.count();
    participant_params_.builtin.leaseDuration.seconds = 2 * participant_params_.builtin.leaseDuration_announcementperiod.seconds;

    participant_ = eprosima::fastrtps::rtps::RTPSDomain::createParticipant(participant_params_, &participant_listener_);
...
constexpr std::chrono::seconds Endpoint::PARTICIPANT_DISCOVERY_ANNOUNCE_PERIOD;
constexpr std::chrono::seconds Endpoint::WRITER_DISCOVERY_ANNOUNCE_PERIOD;
constexpr std::chrono::seconds Endpoint::READER_DISCOVERY_ANNOUNCE_PERIOD;
